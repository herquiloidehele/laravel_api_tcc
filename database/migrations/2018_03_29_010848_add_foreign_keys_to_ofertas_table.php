...
class AddForeignKeysToOfertasTable extends Migration {
	...
	public function up()
	{
		Schema::table('ofertas', function(Blueprint $table)
		{
			...
			$table->foreign('produtos_unidades_mendidas_id', 'fk_produtores_has_produtos_unidades_mendidas_produtos_unidade2')->references('id')->on('produtos_unidades_medidas')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
