...
class AddForeignKeysToProdutoresTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('localizacoes_id', 'fk_produtores_localizacoes1')->references('id')->on('localizacoes')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('produtores', function(Blueprint $table)
		{
			$table->dropForeign('fk_produtores_localizacoes1');
