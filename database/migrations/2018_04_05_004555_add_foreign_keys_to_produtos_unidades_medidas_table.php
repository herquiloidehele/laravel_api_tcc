...
class AddForeignKeysToProdutosUnidadesMedidasTable extends Migration {
	...
	public function up()
	{
		Schema::table('produtos_unidades_medidas', function(Blueprint $table)
		{
			...
			$table->foreign('unidades_medidas_id', 'fk_produtos_has_unidades_mendidas_unidades_mendidas1')->references('id')->on('unidades_medidas')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
