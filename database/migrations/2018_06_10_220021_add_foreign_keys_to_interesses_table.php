...
class AddForeignKeysToInteressesTable extends Migration {
	...
	public function up()
	{
		Schema::table('interesses', function(Blueprint $table)
		{
			...
			$table->foreign('unidades_medidas_id', 'fk_interesses_unidades_medidas1')->references('id')->on('unidades_medidas')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('interesses', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_interesses_unidades_medidas1');
